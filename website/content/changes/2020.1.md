...
When using the [`text`]({{< relref "/docs/configuration/formatters#text" >}}) or [`stylish`]({{< relref "/docs/configuration/formatters#stylish" >}}) formatters, related information will
appear as indented lines. The [`json`]({{< relref "/docs/configuration/formatters#json" >}}) formatter adds a new field
